...
class RayPPOTrainer(object):
    ...
    def _create_dataloader(self):
        ...
        # consider the design of single controller with a large val dataset  in multi-modal scenarios may lead to oom issues
        val_batch_size = self.config.data.val_batch_size if self.config.data.val_batch_size else  len(self.val_dataset)
